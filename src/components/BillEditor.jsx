        ...
        <div className="card-header">
          ...
          <div className="editor-quick-tools">
            ...
            <button
              ...
              title="Load YES BAITHAK sample receipt items"
            >
        ...
        <div className="card-body editor-sections-container">
          ...
          <div className="editor-category-section food-section shadow-sm">
            <div className="section-header">
              ...
              <div className="section-meta">
                <span className="section-count-badge">{foodItems.length} {foodItems.length === 1 ? 'item' : 'items'}</span>
            ...
            {foodItems.length === 0 ? (
              ...
              <>
                {renderItemTable(foodItems, 'FOOD')}
          ...
          <div className="editor-category-section liquor-section shadow-sm">
            <div className="section-header">
              ...
              <div className="section-meta">
                <span className="section-count-badge">{liquorItems.length} {liquorItems.length === 1 ? 'item' : 'items'}</span>
            ...
            {liquorItems.length === 0 ? (
              ...
              <>
                {renderItemTable(liquorItems, 'LIQUOR')}
                <div className="section-footer-actions">
                  <button
                    type="button"
